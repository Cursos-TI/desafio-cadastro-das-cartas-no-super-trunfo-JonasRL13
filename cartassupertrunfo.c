...
//Pra usar: Execute ./super_trunfo
//Escolha o primeiro atributo pelo número (1 a 5)
//Escolha o segundo atributo, que não pode ser o mesmo do primeiro
//Veja o resultado detalhado e a soma ajustada (densidade invertida para soma)
